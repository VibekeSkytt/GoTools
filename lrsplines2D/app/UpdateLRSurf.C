...
/// Update an excisting LRSplineSurface with the point cloud it was defined from or a new
/// point cloud in the same domain. Run the app with -h or --help for user guidance.
